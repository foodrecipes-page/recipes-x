...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'x'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-x@main/recipes/<cuisine>/<diet>/<slug>.json
```
